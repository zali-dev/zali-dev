...
Я студентка **3 курса** по специальности **«Информационные системы и программирование»** и начинающий backend-разработчик, которому интересно не только писать код, но и понимать, как устроены современные серверные приложения.
